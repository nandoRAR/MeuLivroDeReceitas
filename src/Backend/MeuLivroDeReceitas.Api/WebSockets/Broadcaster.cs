...
public class Broadcaster
{
    ...
    public void InicializarConexao(IHubContext<AdicionarConexao> hubContext,
        string idUsuarioQueGerouQRCode,
        string connectionId)
    {
    ...
    public void SetConnectionIdUsuarioLeitorQRCode(string idUsuarioQueGerouQRCode, 
        string connectionIdUsarioLeitorQRCode)
    {
        var connectionUsuarioQueGerouQRCode = GetConnectionIdDoUsuario(idUsuarioQueGerouQRCode);

        _dictionary.TryGetValue(connectionUsuarioQueGerouQRCode, out var objetoConexao);
