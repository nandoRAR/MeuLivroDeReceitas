...
public static class Boostrapper
{
    ...
    private static void AdicionarChaveAdcionalSenha(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    private static void AdicionarUseCases(this IServiceCollection services)
    {
