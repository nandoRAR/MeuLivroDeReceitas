...
namespace UseCases.Tests.Receita.Deletar;
public class DeletarReceitaUseCaseTest
{
    ...
    private static DeletarReceitaUseCase CriarUseCase(
        ...
        MeuLivroDeReceitas.Domain.Entidades.Receita receita)
    {
        ...
        return new DeletarReceitaUseCase(unidadeDeTrabalho, usuarioLogado, repositorioWrite, repositorioRead);
    }
}
