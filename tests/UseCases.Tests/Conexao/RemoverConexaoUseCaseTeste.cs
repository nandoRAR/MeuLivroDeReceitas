...
using UseCases.Tests.Conexao.InlineData;
...
namespace UseCases.Tests.Conexao;
public class RemoverConexaoUseCaseTeste
{
    ...
    public async Task Validar_Erro_UsuarioInvalido()
    {
        ...
        await acao.Should().ThrowAsync<ErrosDeValidacaoException>()
            .Where(exception => exception.MensagensDeErro.Count == 1 && exception.MensagensDeErro
            .Contains(ResourceMensagensDeErro.USUARIO_NAO_ENCONTRADO));
    }
